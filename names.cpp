...
std::string::const_iterator matchName(std::string::const_iterator pos, std::string::const_iterator end) {
...
std::string::const_iterator matchBlockComment(std::string::const_iterator pos, std::string::const_iterator end) {
...
std::string::const_iterator matchLineComment(std::string::const_iterator pos, std::string::const_iterator end) {
